...
import { ProductCategory, createProductCategory, updateProductCategory } from '../../services/productService';
...
const ProductCategoryModal = ({ category, onClose }: ProductCategoryModalProps) => {
