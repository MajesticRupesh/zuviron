...
const Home = () => {
  ...
  return (
    <div className="relative overflow-x-hidden" >
              ...
              >
                <div className="text-center max-w-4xl mx-auto">
                  ...
                  >
                    ...
                    <Link
                      to="/contact"
                      className="group relative overflow-hidden px-4 sm:px-4 py-3 sm:py-3 bg-transparent border-2 border-white text-white hover:border-brand-400 transition-all duration-300"
                    >
      ...
      {/* About Us Section */}
      <section className="relative pb-32 md:pb-20 overflow-hidden">
        <div className="relative">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative px-4 lg:pl-40 lg:mr-[-80px] py-12 lg:py-24"
            >
              <div className="relative">
                ...
                >
                  <Link
                    to="/about"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-brandpantone-900 text-white transition-colors duration-300 group"
                  >
      ...
      <section className="relative py-32 md:py-40 overflow-hidden" style={{backgroundSize: "200%"}}>
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <div>
              <p 
                className="text-4xl md:text-5xl font-bold mb-8 text-[#041e42]"
              >
                Why Choose Zuviron?
              </p>
            </div>
            <p className="text-gray-900 text-lg md:text-xl !leading-[2] !mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            {features.map((feature, index) => (
              ...
              >
                <div className="relative  p-8 border border-brandpantone-900 h-full">
                  <h3 className="flex text-xl font-semibold mb-4 text-brandpantone-900">
                    <feature.icon className="w-8 h-8 text-brandpantone-900" />
                    <span className='pl-2'>{feature.title}</span>
                  </h3>
                  <p className="text-brandpantone-900">
                    {feature.description}
                  </p>
      ...
      <section className="relative py-10 md:py-12 overflow-hidden">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-8 text-gray-900 !leading-[1.5]">
          ...
          <Link
            to="/contact"
            className="group relative overflow-hidden px-4 sm:px-4 py-3 sm:py-3 bg-brandpantone-900 text-white transition-all duration-300"
          >
