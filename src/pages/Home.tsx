          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                At Zuviron Innovations, we are dedicated to revolutionizing the construction industry through innovative waste management solutions. Our journey began with a simple yet powerful idea: transforming waste materials into valuable building resources.
              </p>
            </motion.div>
          </div>
        </div>
